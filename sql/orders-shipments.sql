...
, to_char(oel.promise_date, 'MM/DD/YYYY') promise_date
 , apps.xxbim_get_calendar_date(decode(oel.ship_from_org_id,85,'BIM',90,'BMX MWF'),greatest(nvl(
    ...
    ,trunc(oel.promise_date)),trunc(oel.request_date)),decode(oel.invoice_to_org_id,222359,2,281854,2,222413,2,0)) promise_date_one
, to_char(oel.actual_shipment_date, 'MM/DD/YYYY') actual_shipment_date
, round(oel.promise_date - oel.actual_shipment_date,0) days_early_from_promise
