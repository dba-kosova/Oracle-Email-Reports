...
, round(avg(sales_order_demand),2) "SO Avg"
, round(stddev(sales_order_demand),2) "SO Std"
, ceil((avg(sales_order_demand)*2 +avg(sales_order_demand)*2+ 2*stddev(sales_order_demand))/5)*5 "New MIN(MOQ)"
, ceil((avg(sales_order_demand)*2 +avg(sales_order_demand)*2+ 3*stddev(sales_order_demand))/5)*5 "New MAX(SS)"
